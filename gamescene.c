...
//sz=z-cz;
                        ...
                        if (cert[ix][iy][iz])
                        {
                            ...
                            else if (z-cz>=0) renderit=0;
                            else if (mp[x][y][z+1][0]>0) renderit=0;
                            else if (mp[x][y][z+1][1]==7) renderit=0;
                            else if (scert[ix][iy][iz+1]==0 && scert[ix+1][iy][iz+1]==0 && scert[ix][iy+1][iz+1]==0 && scert[ix+1][iy+1][iz+1]==0) renderit=0;
                            else
                                /*
...
//zlDrawFromIndice(6);
                            ...
                            else if (scert[ix][iy][iz]==0 && scert[ix+1][iy][iz]==0 && scert[ix][iy+1][iz]==0 && scert[ix+1][iy+1][iz]==0) renderit=0;
                            else
                                /*
                            ...
                            else if (y-cy>=0) renderit=0;
                            else if (mp[x][y+1][z][0]>0) renderit=0;
                            else if (scert[ix][iy+1][iz]==0 && scert[ix+1][iy+1][iz]==0 && scert[ix+1][iy+1][iz+1]==0 && scert[ix][iy+1][iz+1]==0) renderit=0;
                            else
                                /*
                                if (prec[ix][iy+1][iz]==0) renderit=0;else
                            ...
                            else if (scert[ix][iy][iz]==0 && scert[ix+1][iy][iz]==0 && scert[ix+1][iy][iz+1]==0 && scert[ix][iy][iz+1]==0) renderit=0;
                            else
                                /*
                                if (prec[ix][iy][iz]==0) renderit=0;else
                                if (prec[ix+1][iy][iz]==0) renderit=0;else
				...
				ii_ti++; 
                            ...
                            renderit=1;//LEFT
                            if (x<1) renderit=0;
                            else if (x-cx<=0) renderit=0;
                            else if (mp[x-1][y][z][0]>0) renderit=0;
                            else if (scert[ix][iy][iz]==0 && scert[ix][iy+1][iz]==0 && scert[ix][iy+1][iz+1]==0 && scert[ix][iy][iz+1]==0) renderit=0;
                            else
                                /*
                                if (prec[ix][iy+1][iz]==0) renderit=0;else
                                if (prec[ix][iy][iz]==0) renderit=0;else
				...
				ii_ti++; 
                            ...
                            else if (scert[ix+1][iy][iz]==0 && scert[ix+1][iy+1][iz]==0 && scert[ix+1][iy+1][iz+1]==0 && scert[ix+1][iy][iz+1]==0) renderit=0;
                            else
                                /*
                                if (prec[ix+1][iy][iz]==0) renderit=0;else
                                if (prec[ix+1][iy+1][iz]==0) renderit=0;else
