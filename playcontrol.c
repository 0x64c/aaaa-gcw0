...
void procplaycontrol(void)
{
    ...
    if (mousebutton[0])
    {
        ix=(mouseaxis[0]-holdmouseaxis[0])/4;
        iy=(mouseaxis[1]-holdmouseaxis[1])/4;
        ...
        else
        {
            ...
            else
            {
                ...
                if (playeraim==16)
                {
                    ...
                    mob[mobcontrol][13]-=axis[0]/8+axis[2]/8;
                    mob[mobcontrol][12]+=axis[1]/8+axis[3]/8;
                    ...
                    else if (mob[mobcontrol][12]<-512) mob[mobcontrol][12]=-512;
                ...
                else
                {
                    ...
                    if (firstperson==1)
                    {
                        ...
                        else if (mob[mobcontrol][12]<-768) mob[mobcontrol][12]=-768;
                    }
                    else
		    ...
		    mob[mobcontrol][12]+=axis[3]/4;
                    if (mousebutton[0])
                    {
                        mob[mobcontrol][13]-=(mouseaxis[0]-holdmouseaxis[0])/4;
                        mob[mobcontrol][12]+=(mouseaxis[1]-holdmouseaxis[1])/4;
                        if (mob[mobcontrol][13]>512) mob[mobcontrol][13]=512;
                        else if (mob[mobcontrol][13]<-512) mob[mobcontrol][13]=-512;
                        if (mob[mobcontrol][12]>256) mob[mobcontrol][12]=256;
                        else if (mob[mobcontrol][12]<-256) mob[mobcontrol][12]=-256;
                    }
                    else
                    {
                ...
                if (firstperson==1) fpscamerasimple();
                else tpscamera();
            }
        }
}
...
//cameraautism();
        ...
        if (mousebutton[0])
        {
            mob[mobcontrol][7]-=(mouseaxis[0]-holdmouseaxis[0])/4;
            mob[mobcontrol][12]+=(mouseaxis[1]-holdmouseaxis[1])/4;
            if (mob[mobcontrol][12]>1024) mob[mobcontrol][12]=1024;
            else if (mob[mobcontrol][12]<-1024) mob[mobcontrol][12]=-1024;
        }
        else
        {
            mob[mobcontrol][13]=mob[mobcontrol][13]*9/10;
