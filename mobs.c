...
void hurtmob(unsigned char i)
{
    ...
    else zcplaysound3d(mobsonic[mob[i][10]][11],7,mob[i][1],mob[i][2],mob[i][3]+65536);
}
...
//insight
    ...
    else if (mob[i][44]>0) if (mob[i][44]<31) mob[i][44]++;
//insight
    if (mob[i][36]>0)
    {
        mob[i][36]--;
    ...
    if (mob[i][39]>0) {
        mob[i][39]--;
        if (mob[i][39]==0)if (i==mobcontrol) zcplaysound3d(15,5,mob[i][1],mob[i][2],mob[i][3]+65536);
    }
    if (mob[i][40]>0) {
        mob[i][40]--;
        if (mob[i][40]==0)if (i==mobcontrol) zcplaysound3d(15,5,mob[i][1],mob[i][2],mob[i][3]+65536);
    }
...
//z
    if (mob[i][6]!=0)
    {
        ...
        {   //iz>0
            ...
            else if (mpb[xx0[0]>>16][yy0[0]>>16][zz[1]>>16]>0) blockz=1;
            else if (mpb[xx0[1]>>16][yy0[0]>>16][zz[1]>>16]>0) blockz=1;
            else if (mpb[xx0[1]>>16][yy0[1]>>16][zz[1]>>16]>0) blockz=1;
            else if (mpb[xx0[0]>>16][yy0[1]>>16][zz[1]>>16]>0) blockz=1;
        }
        else
        {   //iz<0
            if (zz[0]<0) {
            ...
            else if (mpb[xx0[0]>>16][yy0[0]>>16][zz[0]>>16]>0) blockz=1;
            else if (mpb[xx0[1]>>16][yy0[0]>>16][zz[0]>>16]>0) blockz=1;
            else if (mpb[xx0[1]>>16][yy0[1]>>16][zz[0]>>16]>0) blockz=1;
            else if (mpb[xx0[0]>>16][yy0[1]>>16][zz[0]>>16]>0) blockz=1;
...
//x
    if (mob[i][4]!=0)
    {
        if (mob[i][4]>=0)
        {   //ix>0
            if ((xx[1]>>16)>=mpheader[8]) blockx=1;
            else if (mpb[xx[1]>>16][yy0[0]>>16][zz0[0]>>16]>0) blockx=1;
            else if (mpb[xx[1]>>16][yy0[1]>>16][zz0[0]>>16]>0) blockx=1;
            else if (mpb[xx[1]>>16][yy0[0]>>16][zz0[1]>>16]>0) blockx=1;
            else if (mpb[xx[1]>>16][yy0[1]>>16][zz0[1]>>16]>0) blockx=1;
            else if (mpb[xx[1]>>16][yy0[0]>>16][zz0[2]>>16]>0) blockx=1;
            else if (mpb[xx[1]>>16][yy0[1]>>16][zz0[2]>>16]>0) blockx=1;
        }
        else
        {   //ix<0
            if (xx[0]<0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[0]>>16][zz0[0]>>16]>0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[1]>>16][zz0[0]>>16]>0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[0]>>16][zz0[1]>>16]>0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[1]>>16][zz0[1]>>16]>0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[0]>>16][zz0[2]>>16]>0) blockx=1;
            else if (mpb[xx[0]>>16][yy0[1]>>16][zz0[2]>>16]>0) blockx=1;
        }
        if (blockx==0) {
            mob[i][1]+=mob[i][4];
            xx0[0]+=mob[i][4];
...
//y
    if (mob[i][5]!=0)
    {
        if (mob[i][5]>=0)
        {   //iy>0
            if ((yy[1]>>16)>=mpheader[8]) blocky=1;
            else if (mpb[xx0[0]>>16][yy[1]>>16][zz0[0]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[1]>>16][zz0[0]>>16]>0) blocky=1;
            else if (mpb[xx0[0]>>16][yy[1]>>16][zz0[1]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[1]>>16][zz0[1]>>16]>0) blocky=1;
            else if (mpb[xx0[0]>>16][yy[1]>>16][zz0[2]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[1]>>16][zz0[2]>>16]>0) blocky=1;
        }
        else
        {   //iy<0
            if (yy[0]<0) blocky=1;
            else if (mpb[xx0[0]>>16][yy[0]>>16][zz0[0]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[0]>>16][zz0[0]>>16]>0) blocky=1;
            else if (mpb[xx0[0]>>16][yy[0]>>16][zz0[1]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[0]>>16][zz0[1]>>16]>0) blocky=1;
            else if (mpb[xx0[0]>>16][yy[0]>>16][zz0[2]>>16]>0) blocky=1;
            else if (mpb[xx0[1]>>16][yy[0]>>16][zz0[2]>>16]>0) blocky=1;
        }
        if (blocky==0) {
            mob[i][2]+=mob[i][5];
        }
