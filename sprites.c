...
s32 firesize[8]= {25536,55536,65536,55536,45536,35536,25536,15536}; //missing type
...
//zlRotatey(-camera[4]);
                ...
                case 6://note
                    ...
                    else if (sprite[i][6]==1)zlColor4x(255,0,255,255);
                    else if (sprite[i][6]==2)zlColor4x(0,0,255,255);
                    else
                        zlColor4x(255,255,255,255);
